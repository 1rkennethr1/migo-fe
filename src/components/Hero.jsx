		...
		<Element name="home">
			<Layout>
				<motion.div variants={stagger} initial="initial" animate="animate">
					<motion.h1
						variants={stagger}
						className="text-6xl 2xl:text-7xl mb-5 text-center"
					>
						Discover the{" "}
					...
					<motion.h2
						variants={stagger}
						className="text-2xl 2xl:text-3xl text-center "
					>
